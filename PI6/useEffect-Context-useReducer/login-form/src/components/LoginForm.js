...
const LoginForm = () => {
  ...
  return (
        ...
        <Form.Control type="text" placeholder="Enter email" onChange={ emailHandler } value={ email.value }
          className={ email.isValid === false && 'is-invalid' } onBlur={ validateEmail } ref={ emailRef}/>
        ...
        <Form.Control type="password" placeholder="Password" onChange={ passwordHandler } value={ password.value }
          className={ password.isValid === false && 'is-invalid' } onBlur={ validatePassword } ref={ passwordRef}/>
